...
function spamla(){
	...
	if (message.channel.id = "839918630909378560"){
		if(message.content.startsWith("dmr!nitro")){ //ELLEME ÇALIŞMAZ :D
		try{
...
client.login("ODM4ODQ2NTY5Njc1NDg5MzIx.YJBCvw.UePmMSddFqTt-P-RsfAWYCpKNBA");